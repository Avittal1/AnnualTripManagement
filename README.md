...
<img src="Images/map-me.jpg" width="400"/>

---
## שיפורים:
**לאחר הרשמה ראשונית תוכלי בפעמים הבאות להתחבר בצורה פשוטה יותר למערכת מהדף בית, לדוגמא:**
...
**לתצוגת התלמידות בצורה יעילה יותר בלחיצה אחת:**

בתחתית דף תצוגת המפה כשתלחצו בכפתור "הצג את כולם" -  המפה תתאים את עצמה לתצוגה של כל התלמידות במפה אוטומטית ללא הקטנת או הזזת המפה ידנית, לדוגמא:

<img src="Images/all-view.jpg" width="400"/>

**מקרא מפה:**

>בעיגול התכלת יוצת המיקום הנוכחי שלך.

>ומיקומי התלמידות יוצגו בעיגולים הירוקים.

ניתן לראות את פרטי התלמידה על ידי לחיצה על העיגול המסמל אותה.
